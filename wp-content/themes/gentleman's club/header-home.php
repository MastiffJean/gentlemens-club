...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/logo-small.css" />
    ...
    <div id="header">
        <div id="logo" class="logo">
            <a href="<?php echo site_url('/main'); ?>">
                <img id="logo-img" src="<?php echo get_template_directory_uri(); ?>/img/temp_w_s.png" alt="" style="">
            </a>
            <div id="logo-text">
                <p>
                    <?php
