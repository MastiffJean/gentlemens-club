...
<div id="more" class="category-descr">
    <img src="<?php echo get_template_directory_uri(); ?>/img/category/fh/2.jpg">
    <div class="centered">
        <div class="box box1">
            <div class="cat-cont">
...
<div id="more2" class="category-descr">
    <img src="<?php echo get_template_directory_uri(); ?>/img/category/fh/3.jpg">
    <div class="centered">
